...
//  Corona
//
//  Created by Chris Nyrka on 5/11/20.
//  Copyright © 2020 Chris Nyrka. All rights reserved.
//
...
// MARK: Error Country Entered
        .alert(isPresented: self.$alert, content: {

            Alert(title: Text("Error"), message: Text("Invalid country name"), dismissButton: .destructive(Text("Оk")))
        })
        .onAppear {
...
// MARK: Country enter
    func Dialog(){
        ...
        let alert = UIAlertController(title: "Country", message: "Enter country name", preferredStyle: .alert)
